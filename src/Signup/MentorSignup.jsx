                ...
                <div className="input_info">
                    ...
                    <div className="input_id">
                        ...
                        <div className="id_wrap">
                            ...
                            />
                            <button className="check_double" onClick={idDoubleCheck}
                            style={{'border':'none'}}
                            > 
                            중복확인</button>
                        </div>
                    ...
                    <div className="input_nickname">
                        ...
                        <div className="nickname_wrap">
                            ...
                            />
                            <button className="check_double" 
                            style={{'border':'none'}}onClick={nicknameDoubleCheck}> 중복확인</button>
                        </div>
                    ...
                    <div className="certificate_wrap">
                        ...
                        />
                        <label className="input_file_btn" for="input_file"> 파일첨부</label>
                        </div>
                    ...
                    }}>* (필수) 자격증 또는 재직증명서 첨부</div>
                    </div>
                    <div className="error_message">{inputErrors.certificateError}</div>
                </div>
                </div>
                
                <button className="join_btn" disabled={isFormValid}  onClick={()=>{
                    handleSignUp()
                    navigate('/onboarding')
                    }}>가입하기</button>
            </div>
